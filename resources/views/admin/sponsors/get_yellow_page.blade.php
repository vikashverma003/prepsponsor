...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-file-text-o"></i> YellowPage Data
        </h1>
        <ol class="breadcrumb">  
        </ol>
    </section>
    ...
    <div class="col-md-12">
      ...
      <tr>
            <td><i class="fas fa-long-arrow-alt-right"></i> City</td>
              <td>{{$get_yellow_data->city}}</td>
         </tr>
		 
		   <tr>
            <td><i class="fas fa-long-arrow-alt-right"></i> Business Name</td>
              <td>{{$get_yellow_data->business_name?$get_yellow_data->business_name:''}}</td>
         </tr>
     <tr>
            <td><i class="fas fa-long-arrow-alt-right"></i> Latitude</td>
            <td>{{$get_yellow_data->latitude !=''?$get_yellow_data->latitude:'not found'}}</td>
         </tr>
     <tr>
            <td><i class="fas fa-long-arrow-alt-right"></i> Longitude</td>
            <td>{{$get_yellow_data->longitude !=''?$get_yellow_data->longitude:'not found'}}</td>
         </tr>
     <tr>
       
       <tr>
            <td><i class="fas fa-long-arrow-alt-right"></i> Phone</td>
          <td>{{$get_yellow_data->phone}}</td>
         </tr>
		@if(!empty($additional_data->location)) <tr>
		 ...
		 <tr>
            <td><i class="fas fa-long-arrow-alt-right"></i> City</td>
          <td>{{$additional_data->location->city}}</td>
         </tr>
		 		 <tr>
		 ...
		 <tr>
          ...
          <td>{{$get_yellow_data->email?$get_yellow_data->email:'not found'}}</td>
         </tr>
     
     <tr>
            <td><i class="fas fa-long-arrow-alt-right"></i>Source</td>
          <td>{{$get_yellow_data->source?$get_yellow_data->source:'www.yellowpages.com'}}</td>
         </tr>
